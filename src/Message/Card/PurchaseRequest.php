...
class PurchaseRequest extends AbstractCardRequest
{
    /**
     * @inheritDoc
     */
    ...
    {
        return sprintf('%s/v1/charges', $this->getBaseEndpoint());
    }
    ...
    {
        return \Omnipay\Powerboard\Message\Card\PurchaseResponse::class;
    }
}
