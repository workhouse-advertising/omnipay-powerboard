...
use Omnipay\Powerboard\Message\Card\AuthenticateWithRedirectRequest;
use Omnipay\Powerboard\Test\Message\AbstractMessageTestCase;
use Symfony\Component\HttpFoundation\RedirectResponse as HttpRedirectResponse;
use Symfony\Component\HttpFoundation\Response as HttpResponse;

class AuthenticateWithRedirectRequestTest extends AbstractMessageTestCase
{
    /**
     * @var \Omnipay\Powerboard\Message\Card\AuthenticateWithRedirectRequest
     */
    protected $request;
    ...
    public function setUp() : void
    {
        ...
        $this->request = new AuthenticateWithRedirectRequest($client, $request);
    ...
    {
        $this->setMockHttpResponse('AuthenticateWithRedirectSuccess.txt');

        $response = $this->request->send();
        $this->assertFalse($response->isPending());
        $this->assertTrue($response->isSuccessful());
        $this->assertTrue($response->isRedirect());
        $this->assertTrue($response->getRedirectResponse() instanceof HttpResponse);
    }
    ...
    {
        $this->setMockHttpResponse('AuthenticateWithRedirectFailure.txt');
